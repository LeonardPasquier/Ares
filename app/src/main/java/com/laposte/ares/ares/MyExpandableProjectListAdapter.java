...
/**
 * Created by PECH652 on 29/06/2018.
 */

public class MyExpandableProjectListAdapter extends BaseExpandableListAdapter {
    ...
    public MyExpandableProjectListAdapter(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.card_projet_fils, null);
        }
        ...
        description.setText(childArray.get(0));
        vuln_fortes.setText(childArray.get(1));
        vuln_moyennes.setText(childArray.get(2));
        vuln_faibles.setText(childArray.get(3));
