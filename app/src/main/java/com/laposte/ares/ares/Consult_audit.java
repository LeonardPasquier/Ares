...
/**
 * Created by PECH652 on 10/07/2018.
 */

public class Consult_audit  extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consult_audit);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.tab_bord) {
            Intent intent = new Intent(Consult_audit.this, TableauBord.class);
            startActivity(intent);
        }
        else if (id == R.id.projets) {
            Intent intent = new Intent(Consult_audit.this, Projets.class);
            startActivity(intent);
        }
        else if (id == R.id.audits) {
            Intent intent = new Intent(Consult_audit.this, Audits.class);
            startActivity(intent);
        }
        else if (id == R.id.rapports) {
            Intent intent = new Intent(Consult_audit.this, Rapports.class);
            startActivity(intent);
        }
        else if (id == R.id.jobs) {
            Intent intent = new Intent(Consult_audit.this, Jobs.class);
            startActivity(intent);
        }
        else if (id == R.id.users) {
            Intent intent = new Intent(Consult_audit.this, Users.class);
            startActivity(intent);
        }
